    ...
    <form action="{{ route('iklan.update', $iklan->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('kategori', $iklan->kategori) }}"
            >
            @error('kategori')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('tanggal_peluncuran', $iklan->tanggal_peluncuran) }}"
            >
        ...
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('tanggal_selesai', $iklan->tanggal_selesai) }}"
            >
        ...
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('id_biaya_pemasaran', $iklan->id_biaya_pemasaran) }}"
            >
        ...
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('id_platform', $iklan->id_platform) }}"
            >
            @error('id_platform')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
