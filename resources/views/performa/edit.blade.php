    ...
    <form method="POST" action="{{ route('performa.update', $performa->id) }}">
        ...
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('jumlah_tayang', $performa->jumlah_tayang) }}"
            >
            @error('jumlah_tayang')
        ...
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('jumlah_klik', $performa->jumlah_klik) }}"
            >
            @error('jumlah_klik')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('konversi', $performa->konversi) }}"
            >
            @error('konversi')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('tanggal', \Illuminate\Support\Carbon::parse($performa->tanggal)->format('Y-m-d')) }}"
            >
            @error('tanggal')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('id_platform', $performa->id_platform) }}"
            >
            @error('id_platform')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
